...
export const BUNDLES: Bundle[] = [
  {
    ...
    tagline: "All Success Toolkits + Playbooks + Marketplace Plus membership",
  ...
  },
  {
    ...
    description: "The premier flagship suite: All 6 success toolkits, all complete video masterclasses on Atlas Academy with 10 staff training licenses, and 2 months of Marketplace Membership Plus.",
