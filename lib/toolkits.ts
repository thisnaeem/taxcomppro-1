...
export const BUNDLES: Bundle[] = [
  {
    ...
    tagline: "All 6 Success Toolkits + Playbooks + 2 Months Marketplace Plus",
    ...
    description: "The complete practice defense suite including all 6 success toolkits, staff due diligence training, posters, and VIP community access.",
  ...
  },
  {
    ...
    tagline: "All 6 Toolkits + All 6 Video Courses + 10 Staff Licenses",
    ...
    description: "The premier flagship suite: All 6 success toolkits, all 6 complete video masterclasses on Atlas Academy with 10 staff training licenses, and 2 months of Marketplace Membership Plus.",
    ...
    features: [
      ...
      "2 months FREE Marketplace Membership Plus",
