...
export default function EditProfileModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-slate-100 flex flex-col max-h-[90vh] overflow-hidden my-auto">
        {/* Header */}
        <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black text-[#0A1628]">Edit Professional Profile</h2>
        ...
        {/* Tab Navigation */}
        <div className="flex border-b border-slate-100 px-6 bg-slate-50/70 overflow-x-auto gap-2 shrink-0">
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3.5 py-3 text-xs font-bold whitespace-nowrap border-b-2 transition-all ${
                  isActive
                    ? "border-[#1E56A0] text-[#1E56A0] bg-white rounded-t-xl"
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
            ...
            <div className="space-y-5">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs font-medium focus:border-[#1E56A0] focus:ring-2 focus:ring-[#1E56A0]/10 outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3.5 py-2.5 rounded-xl border border-slate-200 text-xs font-medium focus:border-[#1E56A0] focus:ring-2 focus:ring-[#1E56A0]/10 outline-none"
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-xs font-medium focus:border-[#1E56A0] focus:ring-2 focus:ring-[#1E56A0]/10 outline-none resize-none"
                />
              </div>
          ...
          {activeTab === "credentials" && (
            <div className="space-y-6">
                    ...
                    return (
                      <button
                        ...
                        className={`flex items-center justify-between p-3.5 rounded-xl border text-xs font-bold transition-all text-left ${
                          isSelected
                            ? "bg-blue-50/80 border-[#1E56A0] text-[#1E56A0]"
              ...
              <div className="p-4 rounded-2xl bg-[#0A1628]/5 border border-[#0A1628]/10 space-y-3">
                <div className="flex items-center gap-2 text-[#0A1628] font-bold text-xs">
                ...
                <div className="grid sm:grid-cols-3 gap-3">
                  <div className="bg-white p-3 rounded-xl border border-slate-200/80 flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="text-[11px] font-bold text-slate-800">PTIN Verified</p>
                      <p className="text-[10px] text-slate-400">P12345678</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-3 rounded-xl border border-slate-200/80 flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="text-[11px] font-bold text-slate-800">Background Check</p>
                      <p className="text-[10px] text-emerald-600 font-semibold">Verified Active</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-3 rounded-xl border border-slate-200/80 flex items-center gap-2.5">
                    ...
                    <div>
                      <p className="text-[11px] font-bold text-slate-800">IRS Authorized</p>
                      <p className="text-[10px] text-amber-600 font-semibold">Enrolled Agent</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-3">
                  <input
                    ...
                    className="flex-1 px-3.5 py-2 rounded-xl border border-slate-200 text-xs font-medium focus:border-[#1E56A0] focus:ring-2 focus:ring-[#1E56A0]/10 outline-none"
                  />
                  <button
                    type="button"
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {form.specialties.map((spec) => (
                    <span
                      key={spec}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold bg-[#EAF2FC] text-[#1E56A0] border border-[#1E56A0]/20"
                    >
                      {spec}
                      <button
                        type="button"
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {DEFAULT_SPECIALTY_SUGGESTIONS.filter(
                      ...
                      <button
                        ...
                        className="text-[11px] font-semibold px-2.5 py-1 rounded-lg bg-white border border-slate-200 text-slate-600 hover:border-[#1E56A0] hover:text-[#1E56A0] transition-colors"
                      >
                        + {s}
                      </button>
                    ))}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {form.languages.map((lang) => (
                    <span
                      key={lang}
                      className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-slate-100 text-slate-700"
                    >
                      🗣 {lang}
                      <button
                        type="button"
        ...
        <div className="px-6 py-4 border-t border-slate-100 bg-slate-50/70 flex items-center justify-between shrink-0">
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-xl text-xs font-bold text-slate-500 hover:bg-slate-200/70 transition-colors"
          >
            Cancel
          </button>
