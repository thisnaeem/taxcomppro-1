...
import "../globals.css";
import "./pro-talks/pro-talks.css";
...
export default function SpacesLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`pt-site-layout ${urbanist.variable} font-[var(--font-urbanist,Urbanist),sans-serif] min-h-screen flex flex-col bg-[#06091a]`}>
      <Navbar />
